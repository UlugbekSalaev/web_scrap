...
def get_text(url):
    ...
    #write to db
    sql = "INSERT IGNORE INTO daryouz_texnologiyalar (title, text, date, url, category) VALUES (%s, %s, %s, %s, %s)"
...
for i in range(1, 629):
    print("Page:" + str(i))
    get_urls("https://m.daryo.uz/category/texnologiyalar/page/" + str(i) + "/")
    mydb.commit()
